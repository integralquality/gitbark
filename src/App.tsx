...
function generateReport(result: ScanResult): string {
  const lines: string[] = [];
  lines.push("gitbark — scan report");
  ...
  lines.push("-".repeat(42));
  lines.push("Generated by gitbark");
      ...
      <header className="header">
        <div className="logo-row">
          <svg
            ...
            aria-hidden="true"
          >
            <path d="M6 16 L10 4.5 L14 14Z" fill="currentColor" />
            <path d="M18 14 L22 4.5 L26 16Z" fill="currentColor" />
            <circle cx="16" cy="20" r="10" fill="currentColor" />
            <circle cx="11.5" cy="18" r="2" fill="var(--bg-void)" />
            <circle cx="20.5" cy="18" r="2" fill="var(--bg-void)" />
            <circle cx="12.3" cy="17.2" r="0.65" fill="rgba(255,255,255,0.3)" />
            <circle cx="21.3" cy="17.2" r="0.65" fill="rgba(255,255,255,0.3)" />
            <ellipse cx="16" cy="23" rx="2.5" ry="1.8" fill="var(--bg-void)" />
            <path d="M13.5 25.5 Q16 27.5 18.5 25.5" stroke="var(--bg-void)" strokeWidth="0.8" fill="none" strokeLinecap="round" />
          </svg>
          <h1 className="logo">
        ...
        <p className="description">
          Every git commit embeds an email address in its metadata. For public
          repos, anyone can read these by appending{" "}
          <code>.patch</code> to a commit URL. gitbark samples boundary
          commits from a repository and surfaces any email addresses that are
          publicly visible — so you can find out what's exposed before someone
          else does.
        </p>
      </header>
